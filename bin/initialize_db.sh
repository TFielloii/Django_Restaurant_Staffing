...
JobPosting.objects.create(title='IT Goblin', location=location1, description='Code monkey.', requirements='Must know how to turn it off and back on again.', salary='1.50')
JobPosting.objects.create(title='Jr Grill Associate', location=location2, description='Floor salesman.', requirements='Must be able to sell propane and propane accessories.', salary='12.50')
